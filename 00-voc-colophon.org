...
\begin{minipage}[t]{1\textwidth}
    ...
    \vspace{2em}
    \begin{center}
        {The author certifies that this work is a product of original human creativity. Artificial Intelligence was used as a supportive tool for research and structural refinement, but the final narrative, prose, and creative expressions are the sole work of the author.}
        \end{center}
\end{minipage}}
