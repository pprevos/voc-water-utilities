...
The final chapter discusses methods for implementing {{{voc}}} techniques across various use cases in a water utility. Extracting information from customers has ethical implications, so this book concludes with thoughts and recommendations on collecting sensitive customer data and using algorithmic fairness to ensure that the data is collected in the best interests of the community. 
